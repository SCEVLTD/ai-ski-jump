...
const OPTIMAL_PROGRESS = 0.85

/** Landing grades — error thresholds and payloads */
const GRADES = [
  { maxError: 0.05, grade: 'telemark', multiplier: LANDING_MULT.telemark },
  { maxError: 0.12, grade: 'clean',    multiplier: LANDING_MULT.clean },
  { maxError: 0.20, grade: 'shaky',    multiplier: LANDING_MULT.shaky },
]
